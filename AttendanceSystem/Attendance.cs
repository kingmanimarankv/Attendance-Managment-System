    ...
    public partial class Attendance : Form
    {
        ...
        private void LoadGridData()
        {
            ...
            try
            {
                ...
                sqliteConnection.Open();
                sqliteCommand = sqliteConnection.CreateCommand();
                string txtQuery = "SELECT e.Employee_ID, e.Employee_Name, e.Employee_Role,e.Employee_Project, r.TeamLead, r.ProjectManager, r.VerticalManager FROM Employees e JOIN Employees_Relationship r, Attendance_Entry a WHERE e.Employee_ID = a.Employee_ID AND e.Employee_ID = r.Employee_ID AND a.Status= 'Present' AND a.Date ='" + date + "'";
                sqliteDataAdapter = new SQLiteDataAdapter(txtQuery, sqliteConnection);
                GriddataSet.Reset();
        ...
        private void btn_TeamLead_Click(object sender, EventArgs e)
        {
            ...
            SendMail(EmployeeList, lbl_Email.Text, "Presentees List ("+date+")");
        ...
        void SendMail(string Message, string ToEmail, string MailSubject)
        {
            ...
            using (MailMessage mm = new MailMessage(lbl_SenderEmail.Text, ToEmail))
            {
